...
public class ExecutionContextsBuilder {
  ...
  public ExecutionContextsBuilder addThrowable(String code, String system, Throwable throwable) {

    errorsBuilder.add(new ExecutionContext(code, throwable.getMessage(), system));

    if (throwable.getCause() != null) {
      addThrowable(code, system, throwable.getCause());
    }
